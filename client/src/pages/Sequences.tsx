...
export default function Sequences() {
  ...
  return (
    <div className="p-8 min-h-screen" dir="rtl" style={{ backgroundColor: '#F1F5F9' }}>
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="px-6 py-2.5 text-white text-sm font-medium rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center gap-2 mb-4">
            <span className="w-1 h-5 rounded-full" style={{ backgroundColor: '#4F46E5' }} />
